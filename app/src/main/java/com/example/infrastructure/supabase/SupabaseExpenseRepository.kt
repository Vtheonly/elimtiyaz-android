...
class SupabaseExpenseRepository @Inject constructor(
    ...
    override suspend fun submit(input: SubmitExpenseInput, actorId: String, actorName: String): Result<Expense> = try {
    ...
    override suspend fun approve(id: String, note: String, actorId: String, actorName: String): Result<Expense> = try {
    ...
    override suspend fun reject(id: String, reason: String, actorId: String, actorName: String): Result<Expense> = try {
    ...
    override suspend fun disburse(id: String, actorId: String, actorName: String): Result<Expense> = try {
        val params = kotlinx.serialization.json.buildJsonObject {
            put("p_ticket_id", id)
    ...
    override suspend fun settleProof(id: String, proofPath: String, finalAmount: Long, actorId: String, actorName: String): Result<Expense> = try {
        val params = kotlinx.serialization.json.buildJsonObject {
            put("p_ticket_id", id)
