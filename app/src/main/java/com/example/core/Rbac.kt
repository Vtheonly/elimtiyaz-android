...
enum class Permission(val code: String) {
    ...
    companion object {
        ...
        val DEFAULT_ROLE_PERMISSIONS: Map<Role, Set<Permission>> = mapOf(
            ...
            Role.FINANCIAL_OFFICER to setOf(VIEW_FINANCIALS, COLLECT_PAYMENT, REFUND_PAYMENT, ADJUST_ACCOUNT, GENERATE_RECEIPT, VIEW_DEBT, SEND_REMINDER, SUBMIT_EXPENSE, APPROVE_EXPENSE, DISBURSE_EXPENSE, SETTLE_EXPENSE_PROOF, VIEW_PERSONNEL, VIEW_RELEVE, VIEW_AUDIT_LOG, VIEW_WORKFLOW_RUNS, EXECUTE_WORKFLOW, MANAGE_BACKUPS, USE_AI, VIEW_WORKFORCE_REPORTS, USE_CHAT, VIEW_SALARY),
            Role.TEACHER to setOf(VIEW_ACADEMICS, ENTER_GRADES, ROLL_CALL, ASSIGN_HOMEWORK, VIEW_TASKS, UPDATE_TASK_STATUS, CLOCK_IN_OUT, SUBMIT_REQUESTS, USE_CHAT, VIEW_RELEVE),
            Role.SUPPORT_STAFF to setOf(VIEW_ROSTER, CREATE_PARENT, CREATE_STUDENT, COLLECT_PAYMENT, GENERATE_RECEIPT, VIEW_DEBT, SUBMIT_EXPENSE, VIEW_TASKS, UPDATE_TASK_STATUS, CLOCK_IN_OUT, SUBMIT_REQUESTS, USE_CHAT),
            Role.MANAGER to setOf(VIEW_PERSONNEL, VIEW_DEPARTMENTS, MANAGE_DEPARTMENTS, VIEW_TASKS, MANAGE_TASKS, MANAGE_SCHEDULES, VIEW_ATTENDANCE, APPROVE_REQUESTS, VIEW_PERFORMANCE, VIEW_SALARY, VIEW_WORKFORCE_REPORTS, MANAGE_CHAT_CHANNELS, USE_CHAT, VIEW_AUDIT_LOG),
            Role.BUYER to setOf(MANAGE_PURCHASE_REQUESTS, MANAGE_SUPPLIERS, USE_CHAT, CLOCK_IN_OUT, SUBMIT_REQUESTS, SUBMIT_EXPENSE),
            Role.DRIVER to setOf(MANAGE_DELIVERIES, ACCESS_DRIVER_MODE, USE_CHAT, CLOCK_IN_OUT, SUBMIT_REQUESTS),
            Role.WAREHOUSE_WORKER to setOf(MANAGE_INVENTORY, USE_CHAT, CLOCK_IN_OUT, SUBMIT_REQUESTS),
            Role.WORKER to setOf(VIEW_TASKS, UPDATE_TASK_STATUS, USE_CHAT, CLOCK_IN_OUT, SUBMIT_REQUESTS),
